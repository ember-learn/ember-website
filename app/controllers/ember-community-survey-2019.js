...
const communityParticipation = {
  options: {
    ...
    xAxis: {
      categories: [
        'Writing RFCs', 'Commenting on RFCs',  'Opening PRs',
        'Reading RFCs', 'Stack Overflow', 'emberjs.com blog'
      ],
      title: { text: null }
    },
  },
...
const serverSideFrameworks = {
  ...
  data: [{
    name: '2016',
    color: color2016,
    data: [ 46.1, 25.8, 10.6, 11.0, 9, 7.6
      // , 0, 5.7
    ]
  }, {
    name: '2017',
    color: color2017,
    data: [ 37.9, 20.4, 10.1, 8.8, 10.0, 6.2
      // , 0, 5.8
    ]
  }, {
    name: '2018',
    color: color2018,
    data: [ 35.0, 21.6, 12.5, 20.5, 8.2, 7.7
      // , 7.6, 5.7
    ]
  }
]
...
const editorTool = {
  ...
  data: [{
    name: '2016',
    color: color2016,
    data: [ 39, 39.2, 29.24, 20.6, 6
    //  , 3.9, 5, 3.2
    ]
  }, {
    name: '2017',
    color: color2017,
    data: [ 38.11, 26.56, 26.37, 21.08, 19.31
      //, 4.04, 3.97, 2.27
    ]
  }, {
    name: '2018',
    color: color2018,
    data: [ 28.2, 20.3, 20.5, 19, 37.9
    //  , 3.5, 0, 1.9
    ]
  }
]
...
const applicationUsers = {
  options: {
    ...
    colors: [color2016, color2017, color2018],
    credits: {
      enabled: false
    }
  },
...
const SS_Q101 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.01: How likely are you to recommend Ember to your friends and colleagues?' },
    subtitle: { text: '' },
...
const SS_Q204 = {
  ...
  data: [
    {name: '2017', color: color2017, data: [ {name: 'My employer was not using Ember', y: 53.63}, {name: 'My employer was already using Ember', y: 38.74}, {name: 'Does not apply (e.g. I am a student)', y: 6.56} ] },
{name: '2018', color: color2018, data: [ {name: 'My employer was not using Ember', y: 43.1}, {name: 'My employer was already using Ember', y: 52.3}, {name: 'Does not apply (e.g. I am a student)', y: 4.5} ] },
    {name: '2019', color: color2019, data: [
...
const SS_Q205 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q2.05: When taking your most recent job your pre-existing knowledge of Ember.js was:' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
  ...
  data: [
    {name: '2017', color: color2017, data: [ {name: 'I did not know Ember', y: 47.13}, {name: 'Unimportant', y: 25.49}, {name: 'Very important', y: 12.87}, {name: 'Important', y: 12.87} ] },
    {name: '2018', color: color2018, data: [ {name: 'I did not know Ember', y: 40.9}, {name: 'Unimportant', y: 27.2}, {name: 'Very important', y: 18.1}, {name: 'Important', y: 13.8} ] },
    {name: '2019', color: color2019, data: [
...
const SS_Q301 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q3.01: How many developers at your company are responsible for writing Front-End code?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const SS_Q302 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q3.02: How many developers at your company are responsible for writing Ember code?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: {   categories: [
            '1–10',
...
const SS_Q303 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q3.03: At this time next year, how many Ember developers does your company plan to employ?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const SS_Q305 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q3.05: What is the primary language of apps developed at your business?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const SS_Q405 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.05: What is the primary language of your server-side stack?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q103 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.03: What are the ways you learn about and stay up to date with Ember?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q110 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.10: When learning Ember yourself, or teaching it to someone new, what topics were difficult to understand?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
  ...
  data: [
    ...
    {name: '2019', color: color2019, data: [
      ...
      {name: 'Customizing ember-data via adapters and serializers', y: (100/1232)*639},
...
const MS_Q111 = {
  options: { chart: { type: 'column' },
    ...
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: {categories: ['Atom','Sublime Text','Vim','WebStorm / IntelliJ / Other Jetbrains','VS Code']},
    yAxis: { title: { text: 'Percent' } },
  },
  data: [
    {
  ...
  //    {name: 'Visual Studio', y: (100/1232)*99},
      {name: 'WebStorm / IntelliJ / Other Jetbrains', y: (100/1232)*233},
...
const MS_Q113 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.13: Which operating system(s) do you use for development?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q114 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.14: With which of these other front-end framework(s) do you have experience?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
  ...
  data: [
    ...
    {name: 'Some Experience', color: color2019, data: [
    ...
    {name: 'Advanced Experience', color: emberColors.lightBlue, data: [
...
const MS_Q115 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q1.15: With which of these other front-end framework(s) do you have an advanced level of experience?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q202 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q2.02: Choose the option(s) that best describe your employment situation:' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { categories:  [
  ...
  data: [
    ...
    {name: '2019', color: color2019, data: [
      ...
      {name: 'Employee in a firm doing consulting/client work', y: (100/1232)*157},
      {name: 'Employee working on internal Ember tooling', y: (100/1232)*158},
...
const MS_Q304 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q3.04: What are the accessibility requirements for your business?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q403 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.03: If you use Ember CLI, which version(s) are used in your apps?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q406 = {
  ...
  data: [
    ...
    {name: '2019', color: color2019, data: [
      ...
      {name: 'Rails (Ruby)', y: (100/1232)*435},
      {name: 'Express (JavaScript)', y: (100/1232)*239},
      ...
      {name: 'Django (Python)', y: (100/1232)*93},
      {name: 'MVC or ASP .NET Web API (.NET)', y: (100/1232)*97}]}
]}
...
const MS_Q408 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.08: What testing framework(s) do you use in your Ember apps?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
  ...
  data: [
    ...
    {name: '2019', color: color2019, data: [
      ...
      {name: 'Mocha (via ember-mocha or ember-cli-mocha)', y: (100/1232)*206},
      {name: 'QUnit (via ember-quinit or ember-cli-qunit)', y: (100/1232)*887},
...
const MS_Q411 = {
  ...
  data: [
    ...
    {name: '2019', color: color2019, data: [
      {name: 'Amazon Web Services (S3/ElasticBeanstalk/Lambda/etc.)', y: (100/1232)*688},
      ...
      {name: 'Self-hosted (dedicated infrastructure)', y: (100/1232)*227},
...
const MS_Q412 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.12: What is the primary target platform for your Ember apps?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q413 = {
  ...
  data: [
    {
    name: '2016', color: color2016,
    data: [ 62.6, 48.6, 43.8 ]
  }, {
    name: '2017', color: color2017,
    data: [ 65.6, 49, 39 ]
  }, {
    name: '2018', color: color2018,
    data: [ 69.5, 49.4, 39.9 ]
  },
    {name: '2019', color: color2019, data: [
...
const MS_Q415 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.15: At this time next year, what browser versions do you expect your applications to target?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q416 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.16: Which of these best describes your use of Ember in production applications?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: {
          categories: [
...
const MS_Q417 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q4.17: What method do you rely on for search engine indexing?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
...
const MS_Q601 = {
  options: { chart: { type: 'column' },
    title: { text: 'Q6.01: Did you participate in any of the following surveys?' },
    subtitle: { text: '' },
    tooltip: {pointFormat: '{point.y:.2f}%'},
    xAxis: { type: 'category', },
    yAxis: { title: { text: 'Percent' } },
