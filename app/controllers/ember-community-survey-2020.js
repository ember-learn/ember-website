...
const stackSkillsChart = {
  ...
  data: [
    ...
    // x{ name: 'Ember.js', color: emberColors.ember, data: stackData.emberData },
  ],
};
  ...
  data: [
    {
      name: '2017',
      color: color2017,
      data: [1.9, 5.2, 16.4, 33.3, 41.6, 49.8],
    },
    {
      name: '2018',
      color: color2018,
      data: [3.0, 9.8, 23.8, 52.2, 34.2, 57.8],
    },
  ],
};
...
const teamSize = {
  options: {
    ...
    xAxis: {
      categories: ['None', '1–10', '11–20', '21–50', '51–100', '> 100'],
    },
    yAxis: {
      title: {
        text: 'Percent',
  ...
  data: [
    {
      ...
      data: [
        ...
        { name: '< 1 year', y: (100 / 1006) * 181 },
        { name: '1 - 2 years', y: (100 / 1006) * 173 },
        { name: '2 - 3 years', y: (100 / 1006) * 213 },
        { name: '3 - 4 years', y: (100 / 1006) * 209 },
        { name: '4 - 5 years', y: (100 / 1006) * 200 },
        { name: '5+ years', y: (100 / 1006) * 253 },
