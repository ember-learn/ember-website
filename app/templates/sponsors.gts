...
<template>
  ...
  <section class="container" aria-labelledby="ember-sponsors-and-friends">
    ...
    <p>
      Since its beginnings in 2011, Ember has been able to grow to where we are
      now, thanks to the support&mdash;both financial and technical&mdash;of
    ...
    >
      ...
      <ul class="unstyled grid sm:grid-2 lg:grid-3">
        {{#each
          (sortBy
            "order:asc" "end:desc" "start:asc" (rejectBy "end" @model.sponsors)
          )
          as |sponsor|
        }}
          <li>
      ...
      <ul class="unstyled grid sm:grid-2 lg:grid-3">
        {{#each
          (sortBy
            "tier:desc"
            "order:asc"
            (rejectBy "tier" 1 @model.initiativeSponsors)
          )
          as |sponsor|
        }}
          <li>
            <figure>
              ...
              >
                <img
                  src="/images/users/{{sponsor.image}}"
                  alt="{{sponsor.name}} website"
                  class={{if sponsor.individual "team-image"}}
                  loading="lazy"
                />
              </a>
              <figcaption class="text-muted">
    ...
    >
      ...
      <ul class="unstyled grid sm:grid-2 lg:grid-3">
        {{#each
          (sortBy "end:desc" "start:asc" (filterBy "end" @model.sponsors))
          as |sponsor|
        }}
          <li>
            <figure>
    ...
    >
      ...
      <p>
        ...
        channels. You can provide your donation in either channel. All financial
        contributions are moved to Open Collective and centrally, publicly
        managed there.
      </p>
