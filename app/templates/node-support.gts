...
<template>
  {{pageTitle "Node Support"}}

  <section aria-labelledby="node-support" class="container">
    <div class="layout">
      <div class="lg:col-4 lg:start-2 text-muted mb-5">
        ...
        <p>
          ...
          <a href="https://github.com/nodejs/LTS#lts-schedule">Node.js LTS
            Schedule</a>
          for the
          <code>HEAD</code>
          of our
          <code>main</code>
          branch(es). This means that we will drop support per the
          <a href="https://github.com/nodejs/Release">Node.js Release Working
            Group</a>'s schedule without a major version bump/change of
          ember-cli itself.
        </p>
