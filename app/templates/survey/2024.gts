...
<template>
  {{pageTitle "Ember Community Survey 2024"}}
    ...
    <:body>
      <div class="layout">
        ...
        <div class="lg:col-2">
          ...
          <p>
            At EmberConf, the results to the 2024 survey will be shared with a
            comparison to the
            <LinkTo @route="survey.2022">2022 results</LinkTo>. Detailed
