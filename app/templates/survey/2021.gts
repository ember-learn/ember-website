...
<template>
  {{pageTitle "Ember Community Survey 2021"}}

  <EmberCommunitySurveyIntroduction
    @surveyLogoAlt="Ember Community Survey 2021"
    @surveyLogoSrc="/images/survey/logo2021.svg"
  >
    <p>
    ...
    <:body>
      <div class="layout">
        <div class="lg:col-2">
          ...
          <p>
            No personal identification is attached to survey responses. Last
            year, over 1000 participants shared information about themselves,
        ...
        <div class="lg:col-2">
          ...
          <p>
            To ensure the survey captures a fair measure of our community,
            please share this page on your social networks and with your local
            communities!
          </p>
        </div>
        ...
        <div class="lg:col-2">
          ...
          <p>
            At EmberConf, the results to the 2021 survey will be shared with a
            comparison to the
            <LinkTo @route="survey.2020">2020 results</LinkTo>. Detailed
