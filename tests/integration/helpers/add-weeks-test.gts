    ...
    await render(
      <template>
        <table>
          ...
          <tbody>
            <tr>
              <td>{{ltsRelease.version}}</td>
              <td>{{formatDateTime
                  ltsRelease.promotionDate
                  "MMMM D, YYYY"
                }}</td>
              <td data-test-column="Bugfixes">{{formatDateTime
                  (addWeeks ltsRelease.promotionDate)
                  "MMMM D, YYYY"
                }}</td>
              <td data-test-column="Security Patches">{{formatDateTime
                  (addWeeks ltsRelease.promotionDate)
                  "MMMM D, YYYY"
                }}</td>
            </tr>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td data-test-column="Bugfixes">{{formatDateTime
                  (addWeeks ltsRelease.promotionDate 36)
                  "MMMM D, YYYY"
                }}</td>
              <td data-test-column="Security Patches">{{formatDateTime
                  (addWeeks ltsRelease.promotionDate 54)
                  "MMMM D, YYYY"
                }}</td>
            </tr>
          </tbody>
